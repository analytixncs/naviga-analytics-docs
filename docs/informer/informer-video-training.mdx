...
import { chapters_InformerIntro, chapters_GenClientBasic, chapters_MultivalueFields, chapters_IntroFlowSteps,chapters_IntroPowerscripts, chapters_UsefulJavascript } from "@site/src/components/VideoSeekToData";
...
<YouTubePlayerWithChapters
  ...
  width="1080px"
  height="640px"
  chapters={chapters_IntroPowerscripts}
/>
...
- [.includes() for Strings](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/includes)
- [Mimicing The IN Statement](https://naviga-informer-docs.netlify.app/docs/informer/informer-javascript#mimicking-the-in-keyword)
- [.includes() for Arrays](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes)
...
<YouTubePlayerWithChapters
  ...
  width="1080px"
  height="640px"
  chapters={chapters_UsefulJavascript}
/>
